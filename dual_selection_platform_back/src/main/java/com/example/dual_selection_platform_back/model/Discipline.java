...
public class  Discipline {
    ...
    @ApiModelProperty(value = "学科名称", required = true, example = "")
    private String name;

    @ApiModelProperty(value = "学科代码", required = true, example = "")
    private String code;

    @ApiModelProperty(value = "学科等级", required = false, example = "")
    private String level;

    @ApiModelProperty(value = "学科类型", required = false, example = "")
    private String type;

    @ApiModelProperty(value = "上级学科", required = true, example = "")
    private int parent;

    @ApiModelProperty(value = "备注", required = false, example = "")
    private String note;

    @ApiModelProperty(value = "学院ID", required = true, example = "")

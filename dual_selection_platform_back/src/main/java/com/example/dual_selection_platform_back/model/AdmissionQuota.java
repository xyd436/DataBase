...
public class  AdmissionQuota {
    ...
    @ApiModelProperty(value = "招生指标ID", required = true, example = "")
    private int id;

    @ApiModelProperty(value = "年度", required = true, example = "")
    private int year;

    @ApiModelProperty(value = "年度招生总指标", required = true, example = "")
    private int total_quota;

    @ApiModelProperty(value = "补充指标", required = false, example = "")

...
public class  Choice{
    ...
    @ApiModelProperty(value = "志愿ID", required = true, example = "")
    private int id;
    @ApiModelProperty(value = "志愿优先级", required = true, example = "")
    private int priority;
    @ApiModelProperty(value = "状态", required = true, example = "")
    private String status;
    @ApiModelProperty(value = "导师ID", required = true, example = "")
    private int teacher_id;
    @ApiModelProperty(value = "考生ID", required = true, example = "")

...
skinparam usecase {
  BackgroundColor<<mainBackground>> PaleGreen
  BorderColor<<accentColor>> #005500
  BorderThickness 2
  ArrowColor<<accentColor>> #c3cfe2
}
skinparam actor {
...
rectangle "复试过程导师与学生分配管理部分" {
    ...
    UC_C6 -left-> UC_C5 : 扩展
    UC_C8 -down-> UC_C9 : 包含
    UC_C9 -left-> UC_C10 : 扩展
    UC_C9 -down-> UC_C11 : 包含
    UC_C12 -down-> UC_C11 : 扩展
    UC_C13 -down-> UC_C14 : 包含
    UC_C16 -down-> UC_C17 : 扩展
    UC_C18 -down-> UC_C19 : 包含
    UC_C20 -down-> UC_C19 : 扩展
    UC_C24 -down-> UC_C23 : 包含
    UC_C25 -down-> UC_C26 : 包含
    UC_C10 -down-> UC_C9 : 泛化
}
